...
Add-Migrations AddMigrationRemote　-ContextTypeName UnitusCore.Models.ApplicationDbContext -StartUpProjectName "UnitusCore" -ConnectionString RemoteConnectionString -ConnectionProviderName RemoteConnectionProvider
