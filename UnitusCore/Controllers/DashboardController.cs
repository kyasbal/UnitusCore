...
namespace UnitusCore.Controllers
{
    ...
    public class DashboardController:UnitusApiController
    {
        ...
        private async Task<DetailedProfile> GetUserProfile()
        {
            ...
            return new DetailedProfile(p.BelongedColledge, p.Faculty, p.Major, p.CurrentCource, await GetGithubProfile());
        }
        ...
        {
            public DetailedProfile(string belongingColledge, string faculty, string major, Person.Cource currentGrade, GithubProfile githubProfie)
            {
